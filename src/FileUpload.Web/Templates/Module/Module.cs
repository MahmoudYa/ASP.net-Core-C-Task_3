...
namespace FileUpload.Web.Templates;
...
public class Module : GennyModule
{
    ...
    public override void Run()
    {
        ...
        {
            { $"../FileUpload.Services/{shortPath}{Model}Service.cs", Scaffold("Services/Service") },
            { $"../FileUpload.Validators/{shortPath}{Model}Validator.cs", Scaffold("Validators/Validator") },
            { $"../FileUpload.Controllers/{shortPath}{Controller}.cs", Scaffold("Controllers/Controller") },
            { $"../../test/FileUpload.Tests/Integration/Controllers/{shortPath}{Controller}Tests.cs", Scaffold("Tests/ControllerTests") },

            { $"../FileUpload.Web/Views/{path}/Index.cshtml", Scaffold("Web/Index") },
            { $"../FileUpload.Web/Views/{path}/Create.cshtml", Scaffold("Web/Create") },
            { $"../FileUpload.Web/Views/{path}/Details.cshtml", Scaffold("Web/Details") },
            { $"../FileUpload.Web/Views/{path}/Edit.cshtml", Scaffold("Web/Edit") },
            { $"../FileUpload.Web/Views/{path}/Delete.cshtml", Scaffold("Web/Delete") }
        };

        foreach (String view in model.ViewProperties.Keys.Where(key => key.Length == 0 || model.Views[key] != model.Views[""]))
            results[$"../FileUpload.Web/Resources/Views/{path}/{Model}{view}View.json"] = Scaffold($"Resources/{view}View");

        foreach (Type type in model.EnumTypes)
            results[$"../FileUpload.Web/Resources/Enums/{path}/{type.Name}.json"] = Scaffold("Resources/Enum", Enum.GetNames(type));

        if (!File.Exists($"../FileUpload.Objects/Models/{path}/{Model}.cs") ||
            !File.Exists($"../FileUpload.Objects/Views/{path}/{Model}View.cs"))
            results = new Dictionary<String, GennyScaffoldingResult>
            {
                { $"../FileUpload.Objects/Models/{path}/{Model}.cs", Scaffold("Objects/Model") },
                { $"../FileUpload.Objects/Views/{path}/{Model}View.cs", Scaffold("Objects/View") }
            };
    ...
    private void AddArea()
    {
        ...
        Logger.Write("../FileUpload.Controllers/Area.cs - ");

        String content = File.ReadAllText("../FileUpload.Controllers/Area.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../FileUpload.Controllers/Area.cs", content);
    ...
    {
        Logger.Write("../FileUpload.Web/mvc.sitemap - ");
    ...
    {
        Logger.Write("../FileUpload.Data/Migrations/Configuration.cs - ");

        String content = File.ReadAllText("../FileUpload.Data/Migrations/Configuration.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../FileUpload.Data/Migrations/Configuration.cs", content);
    ...
    {
        Logger.Write("../FileUpload.Web/Views/_ViewImports.cshtml - ");

        String content = File.ReadAllText("../FileUpload.Web/Views/_ViewImports.cshtml");
        String[] imports = Regex.Matches(content, "@using (.+);").Select(match => match.Value).ToArray();
        String[] newImports = imports
            .Append(Area == null ? "@using FileUpload.Controllers;" : $"@using FileUpload.Controllers.{Area};")
            .Distinct()
        ...
        else
        {
            ...
            File.WriteAllText("../FileUpload.Web/Views/_ViewImports.cshtml", content);
    ...
    {
        Logger.Write("../../test/FileUpload.Tests/Helpers/ObjectsFactory.cs - ");

        String content = File.ReadAllText("../../test/FileUpload.Tests/Helpers/ObjectsFactory.cs");
        ModuleModel model = new(Model!, Controller!, Area);
        ...
        else
        {
            ...
            File.WriteAllText("../../test/FileUpload.Tests/Helpers/ObjectsFactory.cs", newContent);
    ...
    {
        Logger.Write("../../test/FileUpload.Tests/Unit/Data/Migrations/ConfigurationTests.cs - ");

        String content = File.ReadAllText("../../test/FileUpload.Tests/Unit/Data/Migrations/ConfigurationTests.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/FileUpload.Tests/Unit/Data/Migrations/ConfigurationTests.cs", content);
    ...
    {
        Logger.Write("../../test/FileUpload.Tests/Helpers/TestingContext.cs - ");

        String content = File.ReadAllText("../../test/FileUpload.Tests/Helpers/TestingContext.cs");
        ...
        else
        {
            ...
            File.WriteAllText("../../test/FileUpload.Tests/Helpers/TestingContext.cs", content);
    ...
    {
        Logger.Write($"../FileUpload.Web/Resources/Shared/{resource}.json - ");
