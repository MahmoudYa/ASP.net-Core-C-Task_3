...
using FileUpload.Objects.Mapping;
...
public static class TestingContext
{
    ...
    {
        IConfiguration config = new ConfigurationBuilder().AddJsonFile($"configuration.testing.json").AddEnvironmentVariables("FileUpload__Testing__").Build();
